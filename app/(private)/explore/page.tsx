  ...
  const renderEventContent = () => {
    ...
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
        {events?.pagination.totalItems > 0 ? (
  ...
  return (
    <div className="container mx-auto px-4">
      <header className="mb-8">
        <h1 className="text-4xl font-bold tracking-tight flex md:hidden">
          Explore Events
        </h1>
        <p className="text-lg text-muted-foreground mt-2">
          Discover workshops, conferences, and meetups happening around the
          globe.
        </p>
      </header>
      ...
      <main>
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                ...
                <PopoverContent className="w-80" align="end">
                  <div className="grid gap-4">
                    ...
                    <div className="grid gap-2">
                      ...
                      <div className="space-y-2">
                        {["Tech", "Music", "Art", "Business", "Health"].map(
                          (cat) => (
                            <div
                              key={cat}
          ...
          <TabsContent value="completed">{renderEventContent()}</TabsContent>
        </Tabs>
      </main>
    </div>
  );
